...
namespace Models.Professor
{
    ...
    {
        private List<Common.Subject> _subjects;
        public ReadOnlyCollection<Common.Subject> AllSubjects { get { return _subjects.AsReadOnly(); } }

        public Subjects(List<Common.Subject> subjects)
        {
            _subjects = subjects;
        }
